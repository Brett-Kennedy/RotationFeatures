...
The tool is limited to 2d spaces as its primary purpose is to enhance interpretability and this is compromised when working in higher-dimensional spaces, as these may not be visualized easily. 

The limitation to 2d spaces also keeps the tool more scalable, as it must consider only each pair of numeric feature. 
